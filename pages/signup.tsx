...
export default function SignUpPage() {
  ...
  const { error: checkSignUpError, requestFunction: checkSignUpRequest } =
  ...
  const handleSubmit = async (e: FormEvent) => {
    e.preventDefault();
    checkEmail(email, setShowError);
    checkSignUpPassword(password, setShowError);
    checkPasswordConform(passwordConform, password, setShowError);
    ...
    const checkResult = await checkSignUpRequest(email);
