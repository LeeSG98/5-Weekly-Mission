...
const GRADIENT_COLORS = {
  article1: "linear-gradient(90.00deg, #fe8a8a 2.00%, #a4ceff 99.00%)",
  article2: "linear-gradient(270.00deg, #6fbaff 13.00%, #ffd88b 95.00%)",
  article3:
    "linear-gradient(99.00deg, #6d7ccd 53.00%, rgba(82, 136, 133, 0.22) 125.00%)",
  article4: "linear-gradient(270.00deg, #fe578f -50.00%, #68e8f9 50.00%)",
};
