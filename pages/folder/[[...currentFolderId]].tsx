...
export default function FolderPage() {
  ...
  const [ChangeFolderNameModal, setChangeFolderNameModal] = useState(false);
  const [DeleteFolderModal, setDeleteFolder] = useState(false);
    ...
    <Layout>
      ...
      {ChangeFolderNameModal && (
        <Modal
          ...
          button="변경하기"
          onClose={setChangeFolderNameModal}
        />
      )}
      {DeleteFolderModal && (
        <Modal
